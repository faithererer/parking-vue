      ...
      <el-form :model="userForm" :rules="rules" ref="userFormRef">
        ...
        <el-form-item label="用户角色" :label-width="formLabelWidth">
          <!-- <el-radio-group
            ...
            style="width: 85%"
          > -->
          <el-radio-group v-model="singleRoleId" style="width: 85%">
...
export default {
  ...
  watch: {
    singleRoleId(newVal) {
      this.userForm.roleIdList = newVal ? [newVal] : [];
    }
  },
  methods: {
    //获取所有停车场信息
    ...
    openEdit(userId) {
      if (userId == null) {
        ...
        userApi.getUserById(userId).then((res) => {
          ...
          this.singleRoleId = this.userForm.roleIdList[0];
        });
      }
